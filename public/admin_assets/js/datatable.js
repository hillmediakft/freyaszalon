    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        ...
                        "metronicAjaxRequestGeneralError": "Hiba történt, próbálja újra!",

                        // data tables spesific
                        "lengthMenu": "<span class='seperator'>|</span> _MENU_ elem",
			...
			"sInfoFiltered": "(_MAX_-ból szűrve)",
                        ...
                        "zeroRecords": "A szűrési feltételeknek 0 elem felel meg!",
                        "paginate": {
                            "previous": "Előző",
                            "next": "Következő",
                            "last": "Utolsó",
