 ...
 **/
var Szolgaltatasok_category = function () {

    var szolgaltatasokCategoryTable = function () {

        var table = $('#szolgaltatasok_category');
        // begin first table
        ...
        var tableWrapper = jQuery('#szolgaltatasok_category_wrapper');
    ...
    var printTable = function () {
        $('#print_szolgaltatasok_category').on('click', function (e) {
            e.preventDefault();
            var divToPrint = document.getElementById("szolgaltatasok");
...
$(document).ready(function () {
    Szolgaltatasok_category.init(); // init szolgaltatasok category page
});