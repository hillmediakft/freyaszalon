...
var Crew_members = function () {
    ...
    var crew_membersTable = function () {

        var table = $('#crew_members');
        // begin first table
        ...
        var tableWrapper = jQuery('#crew_members_wrapper');
    ...
    var deleteOneCrewMemberConfirm = function () {
        $('[id*=delete_crew_member]').on('click', function (e) {
            e.preventDefault();
    ...
    var deleteCrewMembersConfirm = function () {
        $('#del_crew_member_form').submit(function (e) {
            e.preventDefault();
            currentForm = this;
            bootbox.setDefaults({
                locale: "hu",
            ...
            success: function (result) {
                if (result.status == 'success') {
                    ...
                    if (action == 'make_inactive') {
                        ...
                        //$(elem).attr('href', 'admin/crew_members/make_active');
                        ...
                        //$(elem).attr('href', 'admin/crew_members/make_inactive');
    ...
    var viewCrewMemberDialog = function () {
        ...
        $('[id*=details_]').on('click', function (e) {
            ...
            $.ajax({
                type: "POST",
                data: {id: id},
                url: "admin/crew_members/view_job_ajax",
                dataType: "json",
                beforeSend: function () {
                    $('#loadingDiv').html('<img src="public/admin_assets/img/loader.gif">');
                    $('#loadingDiv').show();
                    ...
                    bootbox.dialog({
                        ...
                        buttons: {
                            success: {
                                ...
                                callback: function () {
                                    window.location.href = 'admin/crew_members/update_job/' + data.job_id;
                                }
                            },
                            cancel: {
                                label: "vissza",
    ...
    var printTable = function () {
        $('#print_crew_members').on('click', function (e) {
            e.preventDefault();
            var divToPrint = document.getElementById("crew_members");
            console.log(divToPrint);
//		divToPrint = $('#crew_members tr').find('th:last, td:last').remove();
            newWin = window.open("");
    ...
    return {
        ...
        init: function () {
            ...
            crew_membersTable();
            deleteOneCrewMemberConfirm();
            deleteCrewMembersConfirm();
            enableDisableButtons();
            resetSearchForm();
            hideAlert();
            makeActiveConfirm();
            printTable();
            viewCrewMemberDialog();
