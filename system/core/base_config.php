...
if (isset($_SERVER['SERVER_ADDR']) && ($_SERVER['SERVER_ADDR'] == '127.0.0.1' || $_SERVER['SERVER_ADDR'] == '::1'))
{
    ...
    define('BASE_URL', 'http://freyaszalon/'); //Az oldal elérési útjának beállítása
    ...
    ini_set('error_log', 'php_errors.log'); // Logging file
	
	define('BASE_URL', 'https://freyaszalon.hu/'); //Az oldal elérési útjának beállítása
	define('BASE_PATH', ''); //A domainnév utáni elérési út beállítása
