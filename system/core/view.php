...
class View {
	...
	/**
	 *	Ebbe a tömbbe kerülnek a javascript változók
	 *	@var js_var array	 
	 */
...
HTML;
    ...
    {
    	$this->css_link[] = '<link rel="stylesheet" href="' . Util::auto_version($link) . '" type="text/css" />' . "\r\n";
    }
    ...
    {
    	$this->js_link[] = '<script type="text/javascript" src="' . Util::auto_version($link) . '"></script>' . "\r\n";
    }
     ...
     * link hozzáadása a css_link tömbhöz
     */
    public function add_js_var($string)
    {
    	$this->js_var[] = $string . "\r\n";
    } 
