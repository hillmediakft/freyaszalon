    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="adminprojects">GYIK</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="admin/projects/view_project">GYIK részletek</a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-title">
                        <div class="caption"><i class="fa fa-question-circle"></i>GYIK részletek</div>
                                                   <div class="actions">
                                <a href="admin/refrences/update_project/<?php echo $content[0]['project_id'];?>" class="btn green btn-sm"><i class="fa fa-pencil"></i> GYIK szerkesztése</a>
                                <a href="admin/projects" class="btn default btn-sm"><i class="fa fa-close"></i> Vissza a GYIK listához</a>
