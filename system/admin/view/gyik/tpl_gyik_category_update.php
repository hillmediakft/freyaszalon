    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="admin/gyik">Referenciák listája</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">	
                             ...
                             <div class="form-group">
                                        ...
                                        <input type="text" name="gyik_category_name" id="gyik_category_name" value="<?php echo $this->category_content[0]['gyik_category_name'] ?>" class="form-control input-xlarge" />
                                    </div>
                                    

                                    <!-- régi kategória neve-->
                                    <input type="hidden" name="old_category" value="<?php echo $this->category_content[0]['gyik_category_name']; ?>">
