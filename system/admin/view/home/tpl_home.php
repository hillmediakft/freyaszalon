    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green-haze">
                ...
                <a href="admin/crew_members" class="more">
                    Tovább <i class="fa fa-arrow-right"></i>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat purple-plum">
                ...
                <a href="admin/services" class="more">
                    Tovább <i class="fa fa-arrow-right"></i>
                </a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat yellow-casablanca">
                ...
                <a href="admin/photo_gallery" class="more">
                    Tovább <i class="fa fa-arrow-right"></i>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat blue-chambray">
                ...
                <a href="admin/before_after_photo_gallery" class="more">
                    Tovább <i class="fa fa-arrow-right"></i>
                </a>
            </div>
        </div> 
