<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li><span>Felugró ablak szerkesztése</span></li>
        </ul>
    </div>
                            ...
                            <div class="col-md-12">						
                                <form action="" method="POST" id="update_pop_up_window">	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value="<?php echo $this->data_arr[0]['title']; ?>" class="form-control input-xlarge" />
                                    </div>
                                    <div class="form-group">
                                        <label for="promotion_text" class="control-label">Felugró ablak leírás</label>
                                        <input type="text" name="description" id="description" value="<?php echo $this->data_arr[0]['description']; ?>" class="form-control input-xlarge" />                         
                                    </div>

                                    <div class="form-group">
                                        <label for="promotion_text" class="control-label">Felugró ablak tartalom</label>
                                        <textarea name="content" id="content" class="form-control input-xlarge"><?php echo $this->data_arr[0]['content']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="promotion_status">Felugró ablak státusz</label>
                                        <select name='status' id='status' class="form-control input-xlarge">
                                            <option value="">-- Válasszon --</option>
                                            <option value="1" <?php echo($this->data_arr[0]['status'] == 1) ? 'selected' : '';?>>Aktív</option>
                                            <option value="0" <?php echo($this->data_arr[0]['status'] == 0) ? 'selected' : '';?>>Inaktív</option>
                                        </select>
                                    </div>
