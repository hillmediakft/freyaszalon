                            ...
                            <div class="form-body">			
                                <div class="row">	
                                    <div class="col-md-12">						
                                        ...
                                        <div class="form-group">
                                            <label for="szolgaltatas_info" class="control-label">Bevezető szövegó</label>
                                            <textarea name="szolgaltatas_info" id="szolgaltatas_info" placeholder="" class="form-control" rows="4"></textarea>
                                        </div>
