                    ...
                    <div class="portlet">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                ...
                                <a href="admin/szolgaltatasok/category" class="btn default btn-sm"><i class="fa fa-close"></i> Mégsem</a>
                                ...
                                <div class="col-md-12">						
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 400px; height: 300px;"><img src="<?php echo Config::get('szolgaltatascategoryphoto.upload_path') . $this->category_content[0]['szolgaltatas_list_photo']; ?>" alt=""/></div>
                                            <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 4000px; max-height: 300px; line-height: 20px;"></div>
                                            <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="szolgaltatas_list_name" id="szolgaltatas_list_name" value="<?php echo $this->category_content[0]['szolgaltatas_list_name'] ?>" class="form-control input-xlarge" />
                                     </div>
                                    
                                    <div class="form-group">
                                        <label for="szolgaltatas_list_desc" class="control-label">Kategória leírása <span class="required">*</span></label>
                                        <textarea name="szolgaltatas_list_desc" id="szolgaltatas_list_desc" class="form-control input-xlarge" rows="10"><?php echo $this->category_content[0]['szolgaltatas_list_desc'] ?></textarea>
                                        
                                        
                                    </div>                                   

                                    <!-- régi kép neve-->
                                    <input type="hidden" name="old_img" value="<?php echo $this->category_content[0]['szolgaltatas_list_photo']; ?>">
                                    <!-- régi kategória neve-->
                                    <input type="hidden" name="old_category" value="<?php echo $this->category_content[0]['szolgaltatas_list_name']; ?>">
