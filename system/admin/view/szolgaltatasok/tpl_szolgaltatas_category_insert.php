    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="admin/szolgaltatasok/category">Szolgaltatás kategóriák</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                                ...
                                <div class="col-md-12">						
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 400px; height: 300px;"><img src="<?php echo Config::get('szolgaltatascategoryphoto.upload_path') . 'default.jpg'; ?>" alt=""/></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  name="szolgaltatas_list_desc" id="szolgaltatas_list_name" class="form-control input-xlarge" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>	
