        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-image"></i>Előtte - utána képgaléria kategóriák</div>
                    <div class="actions">
                        <a href="admin/before_after_photo_gallery/category_insert" class="btn blue btn-sm"><i class="fa fa-plus"></i> Új kategória</a>
                    </div>
                </div>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <?php if (Session::get('user_role_id') <= 2) { ?>	
                                                        <li><a href="admin/before_after_photo_gallery/category_update/<?php echo $value['id']; ?>"><i class="fa fa-pencil"></i> Szerkeszt</a></li>
                                                    <?php } ?>

                                                    <?php if (Session::get('user_role_id') <= 2 && !isset($no_of_photos[$value['id']])) { ?>
                                                        <li><a href="admin/before_after_photo_gallery/delete_category/<?php echo $value['id']; ?>" id="delete_category<?php echo $value['id']; ?>"><i class="fa fa-trash"></i> Törlés</a></li>  
                                                        <?php } ?>
