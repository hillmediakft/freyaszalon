                                            ...
                                            <div class="col-md-3 col-sm-4 mix category_<?php echo $value['photo_category']; ?>">
                                                <div class="mix-inner">
                                                    ...
                                                    <div class="mix-details">
                                                        ...
                                                        <a title="kép törlése" id="delete_photo<?php echo $value['photo_id']; ?>"class="mix-delete" href="admin/photo-gallery/delete/<?php echo $value['photo_id']; ?>">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                        <a title="kép szerkesztése" class="mix-edit" href="admin/photo-gallery/edit/<?php echo $value['photo_id']; ?>">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        <a class="mix-preview fancybox-button" href="<?php echo $value['photo_filename']; ?>" title="kép nagyítása" data-rel="fancybox-button">
