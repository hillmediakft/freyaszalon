...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <!-- 
        <h3 class="page-title">
                Munka <small>kategória hozzáadása</small>
        </h3>
        -->
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="admin/crew_members/category">Munkakör kategóriák</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                            ...
                            <div class="row">	
                                <div class="col-md-12">						
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="crew_member_category_name" id="crew_member_list_name" class="form-control input-xlarge" />
                                    </div>
