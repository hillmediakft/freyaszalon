...
// $this->view->debug(true);		
    ...
    public function insert() {
        ...
        $this->view->add_links(array('bootstrap-fileupload', 'ckeditor', 'vframework', 'blog_insert', 'select2'));
    ...
    public function update() {
        ...
        $this->view->add_links(array('bootstrap-fileupload', 'ckeditor', 'vframework', 'blog_update', 'select2'));
