...
class Paginator {
     ...
     */
    function __construct($pagename, $limit = 6, $stages = 2) {
    ...
    public function page_links($uri_path) {
        ...
        if ($lastpage > 1) {
            ...
            // A &laquo; linkje
            if ($this->page_id > 1) {
                $paginate.= '<li><a href="' . $path . $this->pagename . '=' . $prev . '">&laquo;</a></li>';
            } else {
            ...
            if ($this->page_id < $counter - 1) {
                $paginate.= '<li><a href="' . $path . $this->pagename . '=' . $next . '">&raquo;</a></li>';
            } else {
