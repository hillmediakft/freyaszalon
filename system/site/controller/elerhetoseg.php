...
class Elerhetoseg extends Site_controller {

    function __construct() {
        parent::__construct();
        $this->loadModel('elerhetoseg_model');
    }
    ...
    public function index() {
        ...
        $this->view->data_arr = $this->elerhetoseg_model->page_data_query('elerhetoseg');

        $this->view->add_links(array('gmaps', 'jquery-validation', 'elerhetoseg'));
        ...
        $this->view->render('elerhetoseg/tpl_elerhetoseg');
    }
