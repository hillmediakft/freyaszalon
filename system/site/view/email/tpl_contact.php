                            ...
                            <tr>
                                <td style="box-sizing: border-box; padding: 20px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <p style="color: #666; font-size: 14px; font-weight: 700">Tisztelt Freyaszalon!</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                    <td style="color: #999999; font-size: 12px; text-align: center">
                                        <p style="color: #999999; font-size: 12px; text-align: center;">Ez az üzenet a freyaszalon.hu/elerhetoseg weboldalon keresztül érkezett!</p>
                                    </td>
                                </tr>
                                <tr>
                                </tr>
